...
// readTrimmedFile reads path, trims trailing whitespace, and returns
// the contents — or "" on any error. Mirrors the helper in
// credentials.go so sensors_*.go can read device_serial without
