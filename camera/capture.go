...
func StartCapturePipeline(ctx context.Context, cfg *CameraConfig, pub *Publisher) error {
	...
	w, h, br := resolveCaptureVideoParams(cfg, ActiveTier())
...
// running rpicam-vid.
func resolveCaptureVideoParams(cfg *CameraConfig, tier *ABRTier) (width, height, bitrate uint32) {
...
func runTestPipeline(ctx context.Context, cfg *CameraConfig, pattern, kfInterval string, startNum int, pub *Publisher) error {
...
func runTestFileLoop(ctx context.Context, cfg *CameraConfig, testFile, pattern string, startNum int, pub *Publisher) error {
...
func runRealPipeline(ctx context.Context, cfg *CameraConfig, pattern string, startNum int, pub *Publisher) error {
	...
	width, height, bitrate := resolveCaptureVideoParams(cfg, ActiveTier())
